    ...
    class CheckAndProcessInvoicesThread implements Runnable {
        ...
        class CheckNewInvoicesTask implements Callable<ArrayList<File>> {
            ...
            public ArrayList<File> call() throws Exception {
                ...
                new_invoices_found = files_scanner.check_for_new_sap_invoices();
        ...
        class ExtractInvoiceDataTask implements Callable<HashMap<String, String>> {
            ...
            String check_if_its_duplicate(String file_name, HashMap<String, String> extracted_invoice_data_values) {
                ...
                if (check_for_duplicate_invoice_by_data(invoice_data) == false) {
                    ...
                    if (db_manager.insert_invoice_data_prepared_statement(invoice_data)) {
            ...
            boolean check_for_duplicate_invoice_by_data(HashMap<String, String> invoice_data) {
                ...
                DbManager db_manager = new DbManager();
                existing_duplicate_invoice_name = db_manager.check_for_duplicate_invoice_by_data(invoice_data);
                if (existing_duplicate_invoice_name != null) {
                ...
                if (recepient != null && recepient.length() > 0) {
                    ...
                    if (index_of_opening_square_brackets != -1) {
                        ...
                        if (index_of_closing_square_brackets != -1) {
                            recepient = recepient.substring(index_of_opening_square_brackets, index_of_closing_square_brackets);
                        } else {
