...
import invoicetypeutils.DbViewer;
import invoicetypeutils.EmailTester;
import invoicetypeutils.ManageDataExtractionBounderies;
import invoicetypeutils.ManageInvoiceTypes;
import invoicetypeutils.PrinterTester;
...
public class Main extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        testEmails = new javax.swing.JMenuItem();
        viewRecords = new javax.swing.JMenuItem();
        testPrinting = new javax.swing.JMenuItem();
        ...
        testEmails.setText("Test Emails");
        testEmails.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                testEmailsActionPerformed(evt);
            }
        });
        editMenu.add(testEmails);

        viewRecords.setFont(new java.awt.Font("Trebuchet MS", 0, 12)); // NOI18N
        viewRecords.setText("View DB Records");
        viewRecords.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                viewRecordsActionPerformed(evt);
            }
        });
        editMenu.add(viewRecords);

        testPrinting.setFont(new java.awt.Font("Trebuchet MS", 0, 12)); // NOI18N
        testPrinting.setText("Test Printing");
        testPrinting.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                testPrintingActionPerformed(evt);
            }
        });
        editMenu.add(testPrinting);
    ...
    private void testEmailsActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_testEmailsActionPerformed
        System.out.println("Email testee clicked...");
        main_content_pane.removeAll();
        main_content_pane.setLayout(new BorderLayout());
        main_content_pane.add(new EmailTester(), BorderLayout.CENTER);
        main_content_pane.validate();
    }//GEN-LAST:event_testEmailsActionPerformed

    private void viewRecordsActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_viewRecordsActionPerformed
        System.out.println("View db records clicked...");
        main_content_pane.removeAll();
        main_content_pane.setLayout(new BorderLayout());
        main_content_pane.add(new DbViewer(), BorderLayout.CENTER);
        main_content_pane.validate();
    }//GEN-LAST:event_viewRecordsActionPerformed

    private void testPrintingActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_testPrintingActionPerformed
        System.out.println("Show print queue clicked...");
        main_content_pane.removeAll();
        main_content_pane.setLayout(new BorderLayout());
        main_content_pane.add(new PrinterTester(), BorderLayout.CENTER);
        main_content_pane.validate();
    }//GEN-LAST:event_testPrintingActionPerformed
    ...
    private javax.swing.JMenuItem testEmails;
    private static javax.swing.JMenuItem testPrinting;
    private static javax.swing.JMenuItem viewRecords;
    ...
    public static void initializeApp() {
        ...
        if (Config.LICENCE_MODE == 1) {
            ...
            if (folder_paths != null) {
                ...
                Config.LOGS_DIR_PATH = Config.SAP_INVOICES_PATH + "logs";
                //Create the logs folder if it doesnt exist
                File logsDir = new File(Config.LOGS_DIR_PATH);
                if (!logsDir.exists()) {
                    if (logsDir.mkdirs()) {
